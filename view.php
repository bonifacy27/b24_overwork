...
function overtimeRenderRequestComment(string $comment): string
{
    $date = '';
    $author = '';
    $message = $comment;
...
function overtimeRenderRequestComments(array $comments): string
{
    ...
    foreach ($comments as $comment) {
        $html .= overtimeRenderRequestComment((string)$comment);
    }
    $html .= '</div>';
