...
function overtimeBuildSplitWarning(array $segments, array $config): array
{
    ...
    return [
        'required' => true,
        'text' => 'Т.к. период работ затрагивает будни и выходные дни будут созданы несколько заявок на сверхурочную работу и на работу в выходной день. Сверхурочная работа допускается только в будние дни по производственному календарю с 00:00 и до 23:59. Для каждой заявки укажите тип оплаты в каждой из них',
    ];
}
